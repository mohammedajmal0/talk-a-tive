...
const createGroupChat=asyncHandler(async(req,res)=>{
    ...
    try {
        const groupChat = await Chat.create({
            ...
            //below line first finds the created group
            // then populates the users field based on the IDs its containing
            // same for group Admin
            // both population is done without password
